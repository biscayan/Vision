...
SAVED_MODEL = 'latest.pt'
TEST_HUMAN_PATH = option.data_path
NEW_MASK_PATH = option.save_path
os.makedirs(NEW_MASK_PATH, exist_ok=True)

model = smp.UnetPlusPlus('efficientnet-b4', encoder_depth=3, encoder_weights='imagenet', decoder_channels=(256, 128, 64), in_channels=3, classes=LABEL_NUM, activation="tanh")
